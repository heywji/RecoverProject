...
| :---: | :----------: | :---------------------: | :--------------------------: | :----------: | ----------------------- |
| 分区支持  | ext3<br>ext4 |          ext3           |         ext3<br>ext4         | ext2<br>ext3 | ALL                     |
| 扫描时长  |      3s      |           3s            |              0s              | 62s<br>（合并）  | ~30s<br>（合并             |
| 恢复时长  |      2s      |           1s            |              1s              | 62s<br>（合并）  | ~30s<br>（合并             |
| 界面支持  |     CLI      |           CLI           |             CLI              |     CLI      | GUI                     |
| 恢复程度  |     100%     |          100%           |             100%             |      0%      | 50%                     |
| 程序优势  | 支持了ext3和ext4 | 输出信息比较完整具体<br>对专业人士帮助较大 | 支持格式多<br>输出信息规范<br>前俩者的加强升级版 |     null     | 全平台通用<br>支持所有格式<br>操作简单 |
| 总体评价  |     ♥♥♥      |           ♥♥            |            ♥♥♥♥♥             |      ♥       | ♥♥♥♥                    |
